...
import 'dart:io';
import 'package:plantd/results.dart';
import 'package:flutter/material.dart';
import 'package:plantd/Camscreen.dart';
...
//}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: const Color(0xFF21BFBD)),
      drawer: Drawer(
        child: ListView(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              children: <Widget>[
                const Text('Plant Disease Identifier',
